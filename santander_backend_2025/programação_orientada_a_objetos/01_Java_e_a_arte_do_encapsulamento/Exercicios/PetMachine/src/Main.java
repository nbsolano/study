...
public class Main {
    ...
    private static void verifyWater() {
        System.out.println("A máquina está com " + petMachine.getWater() + " litro(s) de água");
    }

    private static void verifyShampoo() {
        System.out.println("A máquina está com " + petMachine.getShampoo() + " litro(s) de shampoo");
    }
